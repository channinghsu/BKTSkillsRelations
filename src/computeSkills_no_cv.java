...
public class computeSkills_no_cv {
    ...
    public double findGOOF(int start, int end, BKTParams params, boolean storelnsigma) {
        double SSR = 0.0;
    ...
    public double findGOOFpstc(int start, int end, BKTParams_ptsc params, int sourceskill) {
        double SSR = 0.0;
        String prevstudent = "FWORPLEJOHN";
        double prevL = 0.0;
        double likelihoodcorrect;
    ...
    public void fit_skill_model(int curskill, boolean howaboutpstc) {
        if (!howaboutpstc) {
            ...
            oldRMSE = findGOOF(startact, endact, oldParams, false);
            ...
            findGOOF(startact, endact, bestParams, true);
        ...
        if (howaboutpstc) {
            ...
            for (int sourceskill = 0; sourceskill <= skillnum; sourceskill++) {
                if (sourceskill != curskill) {
                    ...
                    // Get the initial RMSE.
                    oldRMSE = findGOOFpstc(startact, endact, oldParams, sourceskill);

                    for (Integer i = 0; i < totalSteps; i++) {
                        // Take a random step.
                        BKTParams_ptsc newParams = new BKTParams_ptsc(oldParams, true);

                        newRMSE = findGOOFpstc(startact, endact, newParams, sourceskill);
...
//        String infile_ = "data/ct_train_set.tsv";
        String infile_ = "data/as_train_set.tsv";
        computeSkills_no_cv c = new computeSkills_no_cv();
